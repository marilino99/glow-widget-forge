...
;(function(w,d,u){
  ...
  function render(cfg) {
    ...
    style.textContent = inIframe ? \`
      ...
      .wj-chat-chip{padding:5px 10px;border-radius:20px;border:1px solid \${dark ? 'rgba(255,255,255,0.15)' : '#e2e8f0'};background:\${dark ? 'rgba(255,255,255,0.05)' : '#fff'};color:\${dark ? '#fff' : '#334155'};font-size:12px;cursor:pointer;transition:all 0.15s;text-align:left;white-space:nowrap}
