...
;(function(w,d,u){
  ...
  function render(cfg) {
    ...
    style.textContent = inIframe ? \`
      ...
      #wj-chat-chips{display:flex;flex-direction:row;flex-wrap:wrap;align-items:flex-start;gap:6px;margin-top:12px}
      .wj-chat-chip{padding:6px 14px;border-radius:20px;border:1px solid \${dark ? 'rgba(255,255,255,0.15)' : '#e2e8f0'};background:\${dark ? 'rgba(255,255,255,0.05)' : '#fff'};color:\${dark ? '#fff' : '#334155'};font-size:13px;cursor:pointer;transition:all 0.15s;text-align:left;white-space:nowrap}
    ...
    \` : \`
      ...
      #wj-chat-chips{display:flex;flex-direction:row !important;flex-wrap:wrap !important;align-items:flex-start !important;gap:6px !important;margin-top:12px !important}
      .wj-chat-chip{padding:6px 14px !important;border-radius:20px !important;border:1px solid \${dark ? 'rgba(255,255,255,0.15)' : '#e2e8f0'};background:\${dark ? 'rgba(255,255,255,0.05)' : '#fff'};color:\${dark ? '#fff' : '#334155'};font-size:13px !important;cursor:pointer !important;transition:all 0.15s;text-align:left !important;white-space:nowrap !important}
      .wj-chat-chip:hover{background:\${dark ? 'rgba(255,255,255,0.1)' : '#f1f5f9'};border-color:\${dark ? 'rgba(255,255,255,0.25)' : '#cbd5e1'}}
