...
const SidebarItem = ({
  ...
  return (
    <button
      onClick={onClick}
      className={`flex w-full items-center justify-between rounded-xl pl-0 pr-3 py-1.5 text-left transition-all duration-200 hover:bg-[hsl(0_0%_93%)] hover:scale-[1.02] ${
        active ? "text-primary" : ""
      }`}
    >
