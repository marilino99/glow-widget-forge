    ...
    <Dialog>
      <DialogTrigger asChild>
        <div className="group relative p-[2px] rounded-md overflow-hidden cursor-pointer">
          <div className="absolute inset-[-100%] animate-rainbow-spin bg-[conic-gradient(from_0deg,red,orange,yellow,green,cyan,blue,purple,red)] opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
