  ...
  return <div className={`flex h-full flex-col ${minimal ? '' : 'bg-muted/50 p-6'}`}>
      ...
      <div className={`flex flex-1 flex-col overflow-hidden ${minimal ? '' : 'rounded-2xl border border-border bg-card shadow-xl'}`}>
        ...
        <div className="relative flex-1 overflow-hidden" style={{ backgroundColor: '#f2f3f4' }}>
          ...
          <div className={`flex h-[640px] max-h-[calc(100vh-12rem)] flex-col overflow-hidden rounded-2xl shadow-2xl ${isAnimatingCollapse ? 'animate-widget-collapse' : ''} ${isAnimatingExpand ? 'animate-widget-expand' : ''}`} style={{ backgroundColor: isLight ? '#ffffff' : '#000000', color: isLight ? '#0f172a' : '#ffffff' }}>
                {/* Chat header */}
          ...
          <div className={`flex flex-col h-[640px] max-h-[calc(100vh-12rem)] overflow-hidden rounded-2xl shadow-2xl ${widgetText}`} style={{ backgroundColor: isLight ? '#ffffff' : '#000000' }}>
                {/* Contact page header */}
                <div className="flex items-center justify-between px-4 py-3">
          ...
          <div className={`flex flex-col h-[640px] max-h-[calc(100vh-12rem)] overflow-hidden rounded-2xl shadow-2xl ${widgetText} ${isAnimatingCollapse ? 'animate-widget-collapse' : ''} ${isAnimatingExpand ? 'animate-widget-expand' : ''}`} style={{ backgroundColor: isLight ? '#f8f8f8' : '#000' }}>
                {/* Header */}
                <div className="flex items-center justify-between px-4 py-3">
                  {feedbackStep !== 3 ? (
                    <button onClick={() => { 
...
...
          ...
          <div id="wj-pop" className={`flex flex-col h-[640px] max-h-[calc(100vh-12rem)] overflow-hidden rounded-2xl shadow-2xl ${isSolidMode ? "bg-slate-800" : widgetBg} ${widgetText} ${isAnimatingCollapse ? 'animate-widget-collapse' : ''} ${isAnimatingExpand ? 'animate-widget-expand' : ''}`} style={!isSolidMode && backgroundType !== "image" ? customGradientStyle : {}}>
