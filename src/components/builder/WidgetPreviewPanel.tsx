          ...
          {widgetType === "bottom-bar" && (
            isCollapsed && !isAnimatingCollapse ? (
              ...
              <>
                ...
                <div className="absolute bottom-0 left-0 right-0 h-20 z-10 pointer-events-none" style={{ background: 'linear-gradient(to top, rgba(255,255,255,0.45) 0%, rgba(255,255,255,0.2) 50%, transparent 100%)' }} />
