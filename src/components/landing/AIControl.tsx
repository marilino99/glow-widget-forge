          ...
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="rounded-3xl p-8 md:p-10 pb-40 md:pb-48 relative overflow-hidden" style={{ backgroundColor: "#f4f3f3" }}>
            ...
            <div className="absolute bottom-0 left-0 right-0 h-36 md:h-44">
              <svg viewBox="0 0 400 150" preserveAspectRatio="none" className="w-full h-full">
                ...
                {/* Area fill */}
                <path
                  d="M0,125 C10,130 20,118 35,122 C50,108 60,116 75,100 C90,88 100,98 115,82 C130,70 138,80 155,65 C170,52 178,62 195,48 C210,36 218,46 235,32 C250,20 258,30 275,18 C290,8 298,16 315,6 C330,0 345,8 365,0 L400,0 L400,150 L0,150 Z"
                  fill="url(#chartFillGradient)"
                />
                {/* Line stroke */}
                <path
                  d="M0,125 C10,130 20,118 35,122 C50,108 60,116 75,100 C90,88 100,98 115,82 C130,70 138,80 155,65 C170,52 178,62 195,48 C210,36 218,46 235,32 C250,20 258,30 275,18 C290,8 298,16 315,6 C330,0 345,8 365,0 L400,0"
                  fill="none"
