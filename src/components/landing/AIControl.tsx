          ...
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="rounded-3xl p-8 md:p-10 pb-40 md:pb-48 relative overflow-hidden" style={{ backgroundColor: "#f4f3f3" }}>
            ...
            <div className="absolute bottom-0 left-0 right-0 h-36 md:h-44">
              <svg viewBox="0 0 400 150" preserveAspectRatio="none" className="w-full h-full">
                ...
                {/* Area fill */}
                <path
                  d="M0,120 C15,118 30,122 45,115 C60,108 70,112 85,105 C100,98 110,100 125,90 C140,80 148,84 160,78 C175,70 182,74 195,65 C210,56 218,60 230,52 C245,44 252,48 265,38 C280,28 288,32 300,24 C315,16 322,20 340,12 C355,5 370,8 385,2 L400,0 L400,150 L0,150 Z"
                  fill="url(#chartFillGradient)"
                />
                {/* Line stroke */}
                <path
                  d="M0,120 C15,118 30,122 45,115 C60,108 70,112 85,105 C100,98 110,100 125,90 C140,80 148,84 160,78 C175,70 182,74 195,65 C210,56 218,60 230,52 C245,44 252,48 265,38 C280,28 288,32 300,24 C315,16 322,20 340,12 C355,5 370,8 385,2 L400,0"
                  fill="none"
