          ...
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="rounded-3xl p-8 md:p-10 pb-40 md:pb-48 relative overflow-hidden" style={{ backgroundColor: "#f4f3f3" }}>
            ...
            <div className="absolute bottom-0 left-0 right-0 h-36 md:h-44">
              <svg viewBox="0 0 400 150" preserveAspectRatio="none" className="w-full h-full">
                ...
                {/* Area fill */}
                <path
                  d="M0,118 C12,118 18,122 30,122 C42,122 46,110 58,106 C68,103 74,107 84,107 C92,107 98,98 108,93 C118,88 122,94 134,94 C144,94 148,80 162,75 C172,71 178,77 190,77 C198,77 206,65 218,60 C228,56 232,62 244,62 C254,62 262,52 272,46 C280,41 286,48 298,48 C308,48 314,38 326,32 C336,27 340,34 352,34 C360,34 368,20 380,14 C388,10 394,16 400,12 L400,0 L400,150 L0,150 Z"
                  fill="url(#chartFillGradient)"
                />
                {/* Line stroke */}
                <path
                  d="M0,118 C12,118 18,122 30,122 C42,122 46,110 58,106 C68,103 74,107 84,107 C92,107 98,98 108,93 C118,88 122,94 134,94 C144,94 148,80 162,75 C172,71 178,77 190,77 C198,77 206,65 218,60 C228,56 232,62 244,62 C254,62 262,52 272,46 C280,41 286,48 298,48 C308,48 314,38 326,32 C336,27 340,34 352,34 C360,34 368,20 380,14 C388,10 394,16 400,12"
                  fill="none"
