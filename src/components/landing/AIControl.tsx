          ...
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="rounded-3xl p-8 md:p-10 pb-40 md:pb-48 relative overflow-hidden" style={{ backgroundColor: "#f4f3f3" }}>
            ...
            <div className="absolute bottom-0 left-0 right-0 h-36 md:h-44">
              <svg viewBox="0 0 400 150" preserveAspectRatio="none" className="w-full h-full">
                ...
                {/* Area fill */}
                <path
                  d="M0,138 C15,138 20,135 35,133 C50,131 55,136 70,134 C82,132 86,129 98,126 C110,123 114,128 126,124 C136,121 140,115 152,110 C162,106 166,113 178,108 C188,104 192,95 206,88 C216,83 220,92 234,85 C244,80 248,68 264,60 C274,54 278,65 294,55 C304,48 308,34 326,24 C336,18 340,30 358,18 C370,10 380,5 400,2 L400,150 L0,150 Z"
                  fill="url(#chartFillGradient)"
                />
                {/* Line stroke */}
                <path
                  d="M0,138 C15,138 20,135 35,133 C50,131 55,136 70,134 C82,132 86,129 98,126 C110,123 114,128 126,124 C136,121 140,115 152,110 C162,106 166,113 178,108 C188,104 192,95 206,88 C216,83 220,92 234,85 C244,80 248,68 264,60 C274,54 278,65 294,55 C304,48 308,34 326,24 C336,18 340,30 358,18 C370,10 380,5 400,2"
                  fill="none"
