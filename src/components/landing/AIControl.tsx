          ...
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="rounded-3xl p-8 md:p-10 pb-40 md:pb-48 relative overflow-hidden" style={{ backgroundColor: "#f4f3f3" }}>
            ...
            <div className="absolute bottom-0 left-0 right-0 h-36 md:h-44">
              <svg viewBox="0 0 400 150" preserveAspectRatio="none" className="w-full h-full">
                ...
                {/* Area fill */}
                <path
                  d="M0,115 C10,115 15,118 25,118 C35,118 40,108 50,105 C60,102 65,105 75,105 C85,105 90,95 100,92 C110,89 115,92 125,92 C135,92 140,82 150,78 C160,74 165,78 175,78 C185,78 190,68 200,64 C210,60 215,64 225,64 C235,64 240,54 250,50 C260,46 265,50 275,50 C285,50 290,40 300,36 C310,32 315,36 325,36 C335,36 340,26 350,22 C360,18 365,22 375,22 C385,22 390,12 400,8 L400,0 L400,150 L0,150 Z"
                  fill="url(#chartFillGradient)"
                />
                {/* Line stroke */}
                <path
                  d="M0,115 C10,115 15,118 25,118 C35,118 40,108 50,105 C60,102 65,105 75,105 C85,105 90,95 100,92 C110,89 115,92 125,92 C135,92 140,82 150,78 C160,74 165,78 175,78 C185,78 190,68 200,64 C210,60 215,64 225,64 C235,64 240,54 250,50 C260,46 265,50 275,50 C285,50 290,40 300,36 C310,32 315,36 325,36 C335,36 340,26 350,22 C360,18 365,22 375,22 C385,22 390,12 400,8"
                  fill="none"
