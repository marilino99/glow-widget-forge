          ...
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="rounded-3xl p-8 md:p-10 pb-40 md:pb-48 relative overflow-hidden" style={{ backgroundColor: "#f4f3f3" }}>
            ...
            <div className="absolute bottom-0 left-0 right-0 h-36 md:h-44">
              <svg viewBox="0 0 400 150" preserveAspectRatio="none" className="w-full h-full">
                ...
                {/* Area fill */}
                <path
                  d="M0,120 C15,120 20,117 35,115 C50,113 55,118 70,116 C82,114 86,111 98,108 C110,105 114,110 126,106 C136,103 140,97 152,92 C162,88 166,95 178,90 C188,86 192,77 206,70 C216,65 220,74 234,67 C244,62 248,50 264,42 C274,36 278,47 294,37 C304,30 308,16 326,8 C336,3 340,12 358,5 C370,0 380,0 400,0 L400,150 L0,150 Z"
                  fill="url(#chartFillGradient)"
                />
                {/* Line stroke */}
                <path
                  d="M0,120 C15,120 20,117 35,115 C50,113 55,118 70,116 C82,114 86,111 98,108 C110,105 114,110 126,106 C136,103 140,97 152,92 C162,88 166,95 178,90 C188,86 192,77 206,70 C216,65 220,74 234,67 C244,62 248,50 264,42 C274,36 278,47 294,37 C304,30 308,16 326,8 C336,3 340,12 358,5 C370,0 380,0 400,0"
                  fill="none"
