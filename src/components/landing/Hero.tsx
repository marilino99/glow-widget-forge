          ...
          <motion.div custom={3} initial="hidden" animate="visible" variants={fadeUp} className="mt-8 flex flex-col items-start gap-5">
            ...
            <div className="flex items-center gap-3">
              <div className="relative h-11 w-20">
                <img src="https://i.pravatar.cc/80?img=47" alt="" className="absolute left-0 top-0 z-30 h-11 w-11 rounded-2xl border-2 border-background bg-background object-cover shadow-md" />
                ...
                <img src="https://i.pravatar.cc/80?img=11" alt="" className="absolute left-5 top-0 z-10 h-11 w-11 rounded-2xl border-2 border-background bg-background object-cover shadow-sm" />
              </div>
