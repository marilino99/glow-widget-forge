    ...
    <section className="relative overflow-hidden px-6 pb-24 pt-10 md:pb-32 md:pt-16">
      ...
      <div className="mx-auto flex max-w-7xl flex-col items-start gap-12 md:flex-row md:items-center md:gap-16">
        ...
        <div className="flex-1 text-left">
          ...
          >
            <Button size="lg" className="h-14 gap-2 rounded-full px-10 text-base font-bold shadow-[0_8px_30px_-4px_rgba(168,85,247,0.5)] transition-all duration-300 hover:scale-105 hover:-translate-y-0.5 hover:shadow-[0_12px_40px_-4px_rgba(168,85,247,0.7)]" asChild>
              <a href="/signup">
                Start for Free
