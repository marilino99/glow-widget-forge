  ...
  return (
    <section id="dashboard" className="relative px-6 pt-44 pb-24 overflow-hidden">
      ...
      <div
        ...
        style={{
          background: `
            linear-gradient(180deg, #110c29 0%, #110c29 8%, rgba(17,12,41,0.85) 18%, transparent 45%),
            radial-gradient(ellipse 180% 80% at 30% 20%, rgba(124,58,237,0.5) 0%, rgba(109,40,217,0.2) 40%, transparent 70%),
            radial-gradient(ellipse 150% 70% at 75% 30%, rgba(139,92,246,0.3) 0%, transparent 65%),
            radial-gradient(ellipse 80% 50% at 50% 15%, rgba(91,33,182,0.4) 0%, transparent 60%),
            linear-gradient(180deg, transparent 40%, rgba(255,255,255,0.6) 55%, #ffffff 70%)
          `,
