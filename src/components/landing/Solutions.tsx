      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-10">
          {tabs.map((tab) => (
            <button
              ...
              className={`inline-flex items-center rounded-full px-4 py-1 text-xs font-medium transition-all duration-200 ${
                activeTab === tab.id
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            style={{
              background: 'linear-gradient(180deg, hsl(0 0% 100%) 0%, hsl(260 60% 94%) 50%, hsl(270 70% 88%) 100%)',
            }}
          >
            {/* Grain overlay */}
            <div
              className="pointer-events-none absolute inset-0 rounded-3xl opacity-[0.35]"
              style={{
