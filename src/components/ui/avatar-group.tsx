...
const AvatarGroup = ({
  ...
  const displayAvatars = expanded ? avatars : avatars.slice(0, maxVisible);
            ...
            return (
              <motion.div
                ...
                style={{
                  ...
                  zIndex: isHovered ? 50 : displayAvatars.length - idx,
                }}
        ...
        <AnimatePresence>
          {extraCount > 0 && !expanded && (
            <motion.button
              ...
              className="flex items-center justify-center rounded-full border-2 border-background bg-muted text-xs font-semibold text-muted-foreground cursor-pointer hover:bg-accent transition-colors"
              style={{
                width: size,
                height: size,
                marginLeft: -overlap,
